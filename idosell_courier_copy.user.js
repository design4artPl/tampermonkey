...
(function () {
    ...
    function extractFormDataStructured(form) {
        ...
        const fieldLabels = {
            ...
            'dvp_allegro_surcharge': '[UKRYTE] Doplata za kolejna sztuke Allegro (pobranie)',
            'dvp_ebay_surcharge_enabled': '[UKRYTE] Doplata za kolejna sztuke eBay (pobranie)',
            'dvp_ebay_surcharge': '[UKRYTE] Wysokosc doplaty eBay (pobranie)',
