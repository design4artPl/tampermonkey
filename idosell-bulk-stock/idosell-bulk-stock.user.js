...
// @version      1.2.0
// @description  Masowe ustawianie trybu gospodarki, stanu JEST/NIEMA i ilości na konkretnych magazynach dla zaznaczonych towarów (wszystkie strony)
// @author       SyncOffer
...
(function () {
    ...
    function changeAvailability(win, productId, stockId, sizeId, status) {
        return ajaxPost(win, `/panel/ajax/product-edit.php?function=ajaxChangeAvailability&productId=${productId}&stockId=${stockId}&sizeId=${encodeURIComponent(sizeId)}&status=${status}`, '');
    }
