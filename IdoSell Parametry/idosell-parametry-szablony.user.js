...
(function (root) {
  ...
  var CSS = [
    ...
    '.tm-fe-modal { background:#fff !important; border:1px solid #e4e7ec !important; border-radius:14px !important; width:100% !important; max-width:480px !important; box-shadow:0 4px 6px -1px rgba(0,0,0,.06),0 20px 60px -10px rgba(0,0,0,.14) !important; overflow:hidden !important; animation:tmFeModalIn .28s cubic-bezier(.34,1.4,.64,1) !important; max-height:90vh !important; display:flex !important; flex-direction:column !important; }',
    '.tm-fe-modal--wide { max-width:520px !important; }',
    '.tm-fe-header { display:flex !important; align-items:center !important; gap:12px !important; padding:16px 20px !important; border-bottom:1px solid #e4e7ec !important; flex-shrink:0 !important; }',
    '.tm-fe-icon { width:36px !important; height:36px !important; background:#eff4ff !important; border:1px solid #bfcffd !important; border-radius:8px !important; display:flex !important; align-items:center !important; justify-content:center !important; flex-shrink:0 !important; }',
    '.tm-fe-icon svg { width:17px !important; height:17px !important; stroke:#2563eb !important; fill:none !important; }',
    '.tm-fe-title-group h2 { font-size:15px !important; font-weight:600 !important; letter-spacing:-.2px !important; color:#1a202c !important; margin:0 !important; }',
    '.tm-fe-title-group p { font-size:12px !important; color:#9aa3b0 !important; margin:2px 0 0 !important; }',
    '.tm-fe-close { margin-left:auto !important; width:30px !important; height:30px !important; background:none !important; border:1px solid transparent !important; border-radius:7px !important; cursor:pointer !important; display:flex !important; align-items:center !important; justify-content:center !important; color:#9aa3b0 !important; transition:all .15s !important; }',
    '.tm-fe-close:hover { background:#eef0f3 !important; border-color:#e4e7ec !important; color:#1a202c !important; }',
    '.tm-fe-close svg { width:14px !important; height:14px !important; stroke:currentColor !important; stroke-width:2 !important; fill:none !important; }',
    '.tm-fe-body { flex:1 !important; min-height:0 !important; overflow-y:auto !important; }',
    '.tm-fe-footer { display:flex !important; gap:8px !important; justify-content:flex-end !important; padding:14px 20px !important; border-top:1px solid #e4e7ec !important; background:#fafbfc !important; flex-shrink:0 !important; }',
    '.tm-fe-field-block { padding:16px 24px !important; border-bottom:1px solid #e4e7ec !important; }',
    '.tm-fe-field-block:last-child { border-bottom:none !important; }',
    '.tm-fe-field-label { font-size:10.5px !important; font-weight:600 !important; text-transform:uppercase !important; letter-spacing:.7px !important; color:#9aa3b0 !important; margin-bottom:10px !important; }',
    '.tm-fe-radio-group { display:flex !important; flex-direction:column !important; gap:4px !important; }',
    '.tm-fe-radio-group-row { display:flex !important; flex-direction:row !important; gap:6px !important; }',
    '.tm-fe-radio-option { position:relative !important; cursor:pointer !important; display:block !important; }',
    '.tm-fe-radio-option input { position:absolute !important; opacity:0 !important; width:0 !important; height:0 !important; }',
    '.tm-fe-radio-inner { display:flex !important; align-items:center !important; gap:9px !important; padding:7px 10px !important; border-radius:7px !important; border:1.5px solid transparent !important; transition:all .15s !important; }',
    '.tm-fe-radio-inner:hover { background:#f7f8fa !important; }',
    '.tm-fe-radio-option input:checked ~ .tm-fe-radio-inner { background:#eff4ff !important; border-color:#bfcffd !important; }',
    '.tm-fe-radio-dot { width:15px !important; height:15px !important; border-radius:50% !important; border:2px solid #b0bac8 !important; flex-shrink:0 !important; display:flex !important; align-items:center !important; justify-content:center !important; transition:all .18s !important; }',
    '.tm-fe-radio-dot-inner { width:6px !important; height:6px !important; border-radius:50% !important; background:#2563eb !important; transform:scale(0) !important; transition:transform .2s !important; }',
    '.tm-fe-radio-option input:checked ~ .tm-fe-radio-inner .tm-fe-radio-dot { border-color:#2563eb !important; }',
    '.tm-fe-radio-option input:checked ~ .tm-fe-radio-inner .tm-fe-radio-dot-inner { transform:scale(1) !important; }',
    '.tm-fe-radio-text { font-size:13px !important; color:#4a5568 !important; }',
    '.tm-fe-radio-option input:checked ~ .tm-fe-radio-inner .tm-fe-radio-text { color:#2563eb !important; font-weight:500 !important; }',
    '.tm-fe-input-reveal { overflow:hidden !important; max-height:0 !important; opacity:0 !important; transition:max-height .28s ease, opacity .22s ease, margin .28s ease !important; margin-top:0 !important; }',
    '.tm-fe-input-reveal.open { max-height:60px !important; opacity:1 !important; margin-top:4px !important; }',
    '.tm-fe-input-full { width:100% !important; padding:8px 12px !important; border:1.5px solid #e4e7ec !important; border-radius:8px !important; font-size:13px !important; color:#1a202c !important; background:#fff !important; outline:none !important; transition:border-color .15s, box-shadow .15s !important; box-sizing:border-box !important; }',
    '.tm-fe-input-full:focus { border-color:#2563eb !important; box-shadow:0 0 0 3px rgba(37,99,235,.08) !important; }',
    '.tm-fe-input-full::placeholder { color:#9aa3b0 !important; }',
    '.tm-fe-input-full[readonly] { background:#eef0f3 !important; color:#9aa3b0 !important; cursor:default !important; border-color:#e4e7ec !important; }',
    '.tm-fe-input-full[readonly]:focus { border-color:#e4e7ec !important; box-shadow:none !important; }',
    '.tm-fe-btn { font-size:13px !important; font-weight:500 !important; padding:8px 20px !important; border-radius:8px !important; cursor:pointer !important; border:none !important; transition:all .17s !important; letter-spacing:-.1px !important; font-family:inherit !important; }',
    '.tm-fe-btn-ghost { background:transparent !important; border:1.5px solid #e4e7ec !important; color:#4a5568 !important; }',
    '.tm-fe-btn-ghost:hover { border-color:#b0bac8 !important; background:#eef0f3 !important; color:#1a202c !important; }',
    '.tm-fe-btn-primary { background:#2563eb !important; color:#fff !important; box-shadow:0 1px 3px rgba(37,99,235,.3),0 4px 12px rgba(37,99,235,.2) !important; }',
    '.tm-fe-btn-primary:hover { background:#1d4ed8 !important; transform:translateY(-1px) !important; box-shadow:0 1px 4px rgba(37,99,235,.35),0 6px 16px rgba(37,99,235,.25) !important; }',
    '.tm-fe-btn-primary:active { transform:translateY(0) !important; }',
    '.tm-fe-name-block { background:#f7f8fa !important; border:1px solid #e4e7ec !important; border-radius:8px !important; padding:14px 16px !important; }',
    '.tm-fe-name-label { font-size:12px !important; font-weight:500 !important; color:#9aa3b0 !important; margin-bottom:10px !important; text-transform:uppercase !important; letter-spacing:.6px !important; }',
    '.tm-fe-currencies { display:flex !important; flex-direction:column !important; gap:10px !important; padding:0 24px 20px !important; }',
    '.tm-fe-cur-section { border:1px solid #e4e7ec !important; border-radius:8px !important; overflow:hidden !important; }',
    '.tm-fe-cur-header { display:flex !important; align-items:center !important; gap:10px !important; padding:11px 16px !important; background:#f7f8fa !important; border-bottom:1px solid #e4e7ec !important; }',
    '.tm-fe-cur-badge { font-size:11px !important; font-weight:700 !important; font-family:\'Courier New\',monospace !important; padding:3px 8px !important; border-radius:5px !important; letter-spacing:.5px !important; background:#fff !important; border:1px solid #e4e7ec !important; color:#4a5568 !important; }',
    '.tm-fe-badge-pln { background:#fee2e2 !important; color:#dc2626 !important; border-color:#fecaca !important; }',
    '.tm-fe-badge-eur { background:#dbeafe !important; color:#2563eb !important; border-color:#bfdbfe !important; }',
    '.tm-fe-badge-gbp { background:#dcfce7 !important; color:#16a34a !important; border-color:#bbf7d0 !important; }',
    '.tm-fe-cur-title { font-size:12.5px !important; font-weight:600 !important; color:#4a5568 !important; }',
    '.tm-fe-field-row { display:flex !important; align-items:center !important; justify-content:space-between !important; padding:10px 16px !important; border-bottom:1px solid #e4e7ec !important; gap:12px !important; transition:background .12s !important; }',
    '.tm-fe-field-row:last-child { border-bottom:none !important; }',
    '.tm-fe-field-row:hover { background:#f7f8fa !important; }',
    '.tm-fe-field-row-label { font-size:12.5px !important; color:#4a5568 !important; flex:1 !important; }',
    '.tm-fe-num-wrap { position:relative !important; display:flex !important; align-items:center !important; }',
    '.tm-fe-num-input { width:90px !important; padding:6px 28px 6px 10px !important; border:1.5px solid #e4e7ec !important; border-radius:8px !important; font-family:\'Courier New\',monospace !important; font-size:13px !important; font-weight:500 !important; color:#1a202c !important; background:#fff !important; outline:none !important; transition:all .15s !important; text-align:right !important; -moz-appearance:textfield !important; appearance:textfield !important; box-sizing:border-box !important; }',
    '.tm-fe-num-input::-webkit-inner-spin-button, .tm-fe-num-input::-webkit-outer-spin-button { -webkit-appearance:none !important; }',
    '.tm-fe-num-input:focus { border-color:#2563eb !important; box-shadow:0 0 0 3px rgba(37,99,235,.08) !important; }',
    '.tm-fe-spin-btns { position:absolute !important; right:1px !important; top:1px !important; bottom:1px !important; display:flex !important; flex-direction:column !important; width:22px !important; }',
    '.tm-fe-spin-btn { flex:1 !important; background:none !important; border:none !important; border-left:1px solid #e4e7ec !important; cursor:pointer !important; display:flex !important; align-items:center !important; justify-content:center !important; color:#9aa3b0 !important; transition:all .12s !important; padding:0 !important; }',
    '.tm-fe-spin-btn:first-child { border-bottom:1px solid #e4e7ec !important; border-radius:0 5px 0 0 !important; }',
    '.tm-fe-spin-btn:last-child { border-radius:0 0 5px 0 !important; }',
    '.tm-fe-spin-btn:hover { background:#eef0f3 !important; color:#1a202c !important; }',
    '.tm-fe-spin-btn svg { width:8px !important; height:8px !important; stroke:currentColor !important; stroke-width:2.5 !important; fill:none !important; }',
...
`;
  ...
  function _feCreateNameBlock(doc, filterId, defaultName, customName) {
    ...
    var defReveal = doc.createElement('div'); defReveal.className = 'tm-fe-input-reveal';
    if (!hasCustom) { defReveal.style.maxHeight = '60px'; defReveal.style.opacity = '1'; defReveal.style.marginTop = '4px'; }
    ...
    defOpt.querySelector('input').addEventListener('change', function () {
      defReveal.style.maxHeight = '60px'; defReveal.style.opacity = '1'; defReveal.style.marginTop = '4px';
      customReveal.className = 'tm-fe-input-reveal';
    });
    customOpt.querySelector('input').addEventListener('change', function () {
      defReveal.style.maxHeight = '0'; defReveal.style.opacity = '0'; defReveal.style.marginTop = '0';
