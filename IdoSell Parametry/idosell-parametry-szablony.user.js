  ...
  async function performValueMove(doc, sourceId, sourceName, sourceParamId, targetParamId, targetParamName) {
    ...
    try {
      ...
      var msg = 'Przeniesiono \u201e' + sourceName + '\u201d do \u201e' + targetParamName +
        '\u201d \u2014 przekierowan 301: ' + redirOk + (redirFail ? (', nieudanych: ' + redirFail) : '');
  ...
  function mountSectionsPanel(doc) {
    ...
    var sectionsPanel = PanelPro.mount(doc, {
      ...
      columns: [
        ...
        { id: 'products', label: 'Produkty', width: '110px' },
        { id: 'gfx',      label: 'Grafika',  width: '110px' },
    ...
    sections.forEach(function (sec) {
      ...
      li.innerHTML =
        ...
        '<div style="display:flex;align-items:center;justify-content:center;gap:6px">' +
          '<span class="material-symbols-outlined" data-act="settings" title="Edytuj ustawienia (opis, grafiki)" style="cursor:pointer;color:#5f6368;font-size:20px">settings</span>' +
