        ...
        '<div style="padding:0 22px 20px">' +
          ...
          '<div style="padding:14px 0;border-top:1px solid #f0f2f5">' +
            ...
            '<div style="position:relative">' +
              '<select class="tpcd-src" style="width:100%;padding:0 36px 0 14px;height:42px;line-height:42px;border-radius:8px;border:1px solid #e0e3ea;background:#f8f9fb;font-size:13.5px;color:#1a1a2e;appearance:none;-webkit-appearance:none;-moz-appearance:none;outline:none;cursor:pointer;font-family:' + FONT + ';box-sizing:border-box;vertical-align:middle">' + srcOpts + '</select>' +
