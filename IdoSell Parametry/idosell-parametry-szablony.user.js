...
(function (root) {
  ...
  var CSS = [
    ...
    '.tm-fe-overlay .tm-fe-modal { background:#fff !important; border:1px solid #e4e7ec !important; border-radius:14px !important; width:100% !important; max-width:480px !important; box-shadow:0 4px 6px -1px rgba(0,0,0,.06),0 20px 60px -10px rgba(0,0,0,.14) !important; overflow:hidden !important; animation:tmFeModalIn .28s cubic-bezier(.34,1.4,.64,1) !important; max-height:90vh !important; display:flex !important; flex-direction:column !important; }',
    '.tm-fe-overlay .tm-fe-modal--wide { max-width:520px !important; }',
    '.tm-fe-overlay .tm-fe-header { display:flex !important; align-items:center !important; gap:12px !important; padding:16px 20px !important; border-bottom:1px solid #e4e7ec !important; flex-shrink:0 !important; }',
    '.tm-fe-overlay .tm-fe-icon { width:36px !important; height:36px !important; background:#eff4ff !important; border:1px solid #bfcffd !important; border-radius:8px !important; display:flex !important; align-items:center !important; justify-content:center !important; flex-shrink:0 !important; }',
    '.tm-fe-overlay .tm-fe-icon svg { width:17px !important; height:17px !important; stroke:#2563eb !important; fill:none !important; }',
    '.tm-fe-overlay .tm-fe-title-group h2 { font-size:15px !important; font-weight:600 !important; letter-spacing:-.2px !important; color:#1a202c !important; margin:0 !important; }',
    '.tm-fe-overlay .tm-fe-title-group p { font-size:12px !important; color:#9aa3b0 !important; margin:2px 0 0 !important; }',
    '.tm-fe-overlay .tm-fe-close { margin-left:auto !important; width:30px !important; height:30px !important; background:none !important; border:1px solid transparent !important; border-radius:7px !important; cursor:pointer !important; display:flex !important; align-items:center !important; justify-content:center !important; color:#9aa3b0 !important; transition:all .15s !important; }',
    '.tm-fe-overlay .tm-fe-close:hover { background:#eef0f3 !important; border-color:#e4e7ec !important; color:#1a202c !important; }',
    '.tm-fe-overlay .tm-fe-close svg { width:14px !important; height:14px !important; stroke:currentColor !important; stroke-width:2 !important; fill:none !important; }',
    '.tm-fe-overlay .tm-fe-body { flex:1 !important; min-height:0 !important; overflow-y:auto !important; }',
    '.tm-fe-overlay .tm-fe-footer { display:flex !important; gap:8px !important; justify-content:flex-end !important; padding:14px 20px !important; border-top:1px solid #e4e7ec !important; background:#fafbfc !important; flex-shrink:0 !important; }',
    '.tm-fe-overlay .tm-fe-field-block { padding:16px 24px !important; border-bottom:1px solid #e4e7ec !important; }',
    '.tm-fe-overlay .tm-fe-field-block:last-child { border-bottom:none !important; }',
    '.tm-fe-overlay .tm-fe-field-label { font-size:10.5px !important; font-weight:600 !important; text-transform:uppercase !important; letter-spacing:.7px !important; color:#9aa3b0 !important; margin-bottom:10px !important; }',
    '.tm-fe-overlay .tm-fe-radio-group { display:flex !important; flex-direction:column !important; gap:4px !important; }',
    '.tm-fe-overlay .tm-fe-radio-group-row { display:flex !important; flex-direction:row !important; gap:6px !important; }',
    '.tm-fe-overlay .tm-fe-radio-option { position:relative !important; cursor:pointer !important; display:block !important; }',
    '.tm-fe-overlay .tm-fe-radio-option input { position:absolute !important; opacity:0 !important; width:0 !important; height:0 !important; }',
    '.tm-fe-overlay .tm-fe-radio-inner { display:flex !important; align-items:center !important; gap:9px !important; padding:7px 10px !important; border-radius:7px !important; border:1.5px solid transparent !important; transition:all .15s !important; }',
    '.tm-fe-overlay .tm-fe-radio-inner:hover { background:#f7f8fa !important; }',
    '.tm-fe-overlay .tm-fe-radio-option input:checked ~ .tm-fe-radio-inner { background:#eff4ff !important; border-color:#bfcffd !important; }',
    '.tm-fe-overlay .tm-fe-radio-dot { width:15px !important; height:15px !important; border-radius:50% !important; border:2px solid #b0bac8 !important; flex-shrink:0 !important; display:flex !important; align-items:center !important; justify-content:center !important; transition:all .18s !important; }',
    '.tm-fe-overlay .tm-fe-radio-dot-inner { width:6px !important; height:6px !important; border-radius:50% !important; background:#2563eb !important; transform:scale(0) !important; transition:transform .2s !important; }',
    '.tm-fe-overlay .tm-fe-radio-option input:checked ~ .tm-fe-radio-inner .tm-fe-radio-dot { border-color:#2563eb !important; }',
    '.tm-fe-overlay .tm-fe-radio-option input:checked ~ .tm-fe-radio-inner .tm-fe-radio-dot-inner { transform:scale(1) !important; }',
    '.tm-fe-overlay .tm-fe-radio-text { font-size:13px !important; color:#4a5568 !important; }',
    '.tm-fe-overlay .tm-fe-radio-option input:checked ~ .tm-fe-radio-inner .tm-fe-radio-text { color:#2563eb !important; font-weight:500 !important; }',
    '.tm-fe-overlay .tm-fe-input-reveal { overflow:hidden !important; max-height:0 !important; opacity:0 !important; transition:max-height .28s ease, opacity .22s ease, margin .28s ease !important; margin-top:0 !important; }',
    '.tm-fe-overlay .tm-fe-input-reveal.open { max-height:60px !important; opacity:1 !important; margin-top:4px !important; }',
    '.tm-fe-overlay .tm-fe-input-full { width:100% !important; padding:8px 12px !important; border:1.5px solid #e4e7ec !important; border-radius:8px !important; font-size:13px !important; color:#1a202c !important; background:#fff !important; outline:none !important; transition:border-color .15s, box-shadow .15s !important; box-sizing:border-box !important; }',
    '.tm-fe-overlay .tm-fe-input-full:focus { border-color:#2563eb !important; box-shadow:0 0 0 3px rgba(37,99,235,.08) !important; }',
    '.tm-fe-overlay .tm-fe-input-full::placeholder { color:#9aa3b0 !important; }',
    '.tm-fe-overlay .tm-fe-input-full[readonly] { background:#eef0f3 !important; color:#9aa3b0 !important; cursor:default !important; border-color:#e4e7ec !important; }',
    '.tm-fe-overlay .tm-fe-input-full[readonly]:focus { border-color:#e4e7ec !important; box-shadow:none !important; }',
    '.tm-fe-overlay .tm-fe-btn { font-size:13px !important; font-weight:500 !important; padding:8px 20px !important; border-radius:8px !important; cursor:pointer !important; border:none !important; transition:all .17s !important; letter-spacing:-.1px !important; font-family:inherit !important; }',
    '.tm-fe-overlay .tm-fe-btn-ghost { background:transparent !important; border:1.5px solid #e4e7ec !important; color:#4a5568 !important; }',
    '.tm-fe-overlay .tm-fe-btn-ghost:hover { border-color:#b0bac8 !important; background:#eef0f3 !important; color:#1a202c !important; }',
    '.tm-fe-overlay .tm-fe-btn-primary { background:#2563eb !important; color:#fff !important; box-shadow:0 1px 3px rgba(37,99,235,.3),0 4px 12px rgba(37,99,235,.2) !important; }',
    '.tm-fe-overlay .tm-fe-btn-primary:hover { background:#1d4ed8 !important; transform:translateY(-1px) !important; box-shadow:0 1px 4px rgba(37,99,235,.35),0 6px 16px rgba(37,99,235,.25) !important; }',
    '.tm-fe-overlay .tm-fe-btn-primary:active { transform:translateY(0) !important; }',
    '.tm-fe-overlay .tm-fe-name-block { background:#f7f8fa !important; border:1px solid #e4e7ec !important; border-radius:8px !important; padding:14px 16px !important; }',
    '.tm-fe-overlay .tm-fe-name-label { font-size:12px !important; font-weight:500 !important; color:#9aa3b0 !important; margin-bottom:10px !important; text-transform:uppercase !important; letter-spacing:.6px !important; }',
    '.tm-fe-overlay .tm-fe-currencies { display:flex !important; flex-direction:column !important; gap:10px !important; padding:0 24px 20px !important; }',
    '.tm-fe-overlay .tm-fe-cur-section { border:1px solid #e4e7ec !important; border-radius:8px !important; overflow:hidden !important; }',
    '.tm-fe-overlay .tm-fe-cur-header { display:flex !important; align-items:center !important; gap:10px !important; padding:11px 16px !important; background:#f7f8fa !important; border-bottom:1px solid #e4e7ec !important; }',
    '.tm-fe-overlay .tm-fe-cur-badge { font-size:11px !important; font-weight:700 !important; font-family:\'Courier New\',monospace !important; padding:3px 8px !important; border-radius:5px !important; letter-spacing:.5px !important; background:#fff !important; border:1px solid #e4e7ec !important; color:#4a5568 !important; }',
    '.tm-fe-overlay .tm-fe-badge-pln { background:#ecfdf5 !important; color:#065f46 !important; border:1px solid #a7f3d0 !important; }',
    '.tm-fe-overlay .tm-fe-badge-eur { background:#fefce8 !important; color:#854d0e !important; border:1px solid #fde68a !important; }',
    '.tm-fe-overlay .tm-fe-badge-gbp { background:#eff4ff !important; color:#1e40af !important; border:1px solid #bfdbfe !important; }',
    '.tm-fe-overlay .tm-fe-cur-title { font-size:12.5px !important; font-weight:600 !important; color:#4a5568 !important; }',
    '.tm-fe-overlay .tm-fe-field-row { display:flex !important; align-items:center !important; justify-content:space-between !important; padding:10px 16px !important; border-bottom:1px solid #e4e7ec !important; gap:12px !important; transition:background .12s !important; }',
    '.tm-fe-overlay .tm-fe-field-row:last-child { border-bottom:none !important; }',
    '.tm-fe-overlay .tm-fe-field-row:hover { background:#f7f8fa !important; }',
    '.tm-fe-overlay .tm-fe-field-row-label { font-size:12.5px !important; color:#4a5568 !important; flex:1 !important; }',
    '.tm-fe-overlay .tm-fe-num-wrap { position:relative !important; display:flex !important; align-items:center !important; }',
    '.tm-fe-overlay .tm-fe-num-input { width:90px !important; padding:6px 28px 6px 10px !important; border:1.5px solid #e4e7ec !important; border-radius:8px !important; font-family:\'Courier New\',monospace !important; font-size:13px !important; font-weight:500 !important; color:#1a202c !important; background:#fff !important; outline:none !important; transition:all .15s !important; text-align:right !important; -moz-appearance:textfield !important; appearance:textfield !important; box-sizing:border-box !important; }',
    '.tm-fe-overlay .tm-fe-num-input::-webkit-inner-spin-button, .tm-fe-num-input::-webkit-outer-spin-button { -webkit-appearance:none !important; }',
    '.tm-fe-overlay .tm-fe-num-input:focus { border-color:#2563eb !important; box-shadow:0 0 0 3px rgba(37,99,235,.08) !important; }',
    '.tm-fe-overlay .tm-fe-spin-btns { position:absolute !important; right:1px !important; top:1px !important; bottom:1px !important; display:flex !important; flex-direction:column !important; width:22px !important; }',
    '.tm-fe-overlay .tm-fe-spin-btn { flex:1 !important; background:none !important; border:none !important; border-left:1px solid #e4e7ec !important; cursor:pointer !important; display:flex !important; align-items:center !important; justify-content:center !important; color:#9aa3b0 !important; transition:all .12s !important; padding:0 !important; }',
    '.tm-fe-overlay .tm-fe-spin-btn:first-child { border-bottom:1px solid #e4e7ec !important; border-radius:0 5px 0 0 !important; }',
    '.tm-fe-overlay .tm-fe-spin-btn:last-child { border-radius:0 0 5px 0 !important; }',
    '.tm-fe-overlay .tm-fe-spin-btn:hover { background:#eef0f3 !important; color:#1a202c !important; }',
    '.tm-fe-overlay .tm-fe-spin-btn svg { width:8px !important; height:8px !important; stroke:currentColor !important; stroke-width:2.5 !important; fill:none !important; }',
...
`;
  ...
  async function saveValueFilters(nodeId, shop, lang, activeIds, pricestep, pricestepnet, perOpts) {
    ...
    var body = 'action=setNodeFilters&node=' + encodeURIComponent(nodeId) +
      ...
      '&filter_pricestepnet=' + encodeURIComponent(pricestepnet || '10');
    // v4.6.125: pelny payload per-filter (jak w Menu setNodeFilters)
    if (perOpts) {
      for (var fid in perOpts) {
        var op = perOpts[fid]; if (!op) continue;
        if (op.custom_name) body += '&filter_' + shop + '_active_name[' + encodeURIComponent(fid) + ']=' + encodeURIComponent(op.custom_name);
        if (op.display) body += '&filter_' + shop + '_active_display[' + encodeURIComponent(fid) + ']=' + encodeURIComponent(op.display);
        if (op.default_enabled) body += '&filter_' + shop + '_active_default_enabled[' + encodeURIComponent(fid) + ']=' + encodeURIComponent(op.default_enabled);
        ...
        if (op.pricerangenet) for (var pnC in op.pricerangenet) {
          var pnObj = op.pricerangenet[pnC] || {};
          for (var pnF in pnObj) body += '&filter_pricerangenet[' + encodeURIComponent(pnC) + '][' + encodeURIComponent(pnF) + ']=' + encodeURIComponent(pnObj[pnF]);
        }
      }
    }
  ...
  async function renderValueFiltersEditor(host, doc, nodeId, shop, lang) {
    ...
    function buildHtml() {
      ...
      html += '<div class="tm-fe-pricestep-field"><span class="tm-fe-pricestep-label">Min. r\u00f3\u017cnica brutto:</span><input id="tpfv_ps_' + nodeId + '" type="number" min="0" value="' + escapeHtml(pricestep) + '" class="tm-fe-input-full"></div>';
      html += '<div class="tm-fe-pricestep-field"><span class="tm-fe-pricestep-label">Min. r\u00f3\u017cnica netto:</span><input id="tpfv_psn_' + nodeId + '" type="number" min="0" value="' + escapeHtml(pricestepnet) + '" class="tm-fe-input-full"></div>';
      html += '</div>';
      html += '</div>';
      html += '</div>';
      return html;
    ...
    var psnInput = host.querySelector('#tpfv_psn_' + nodeId);
    ...
    function badgeFor(filterId) {
      ...
      if (op.pricerange || op.pricerangenet) bits.push('przedziały');
    ...
    return {
      ...
      getPricestepnet: function () {
        return (psnInput && psnInput.value) || '10';
      },
  ...
  function openFilterEditDialog(doc, filterId, filterName, onSave) {
    ...
    var hasFieldBlocks = hasDisplay || hasDefaultEnabled;
  ...
  function showEditElementModal(doc, nodeId) {
    ...
    fetchAjax('action=getParameterLangData&id=' + encodeURIComponent(nodeId)).then(function (resp) {
      ...
      langs.forEach(function (lg) { var L = dt.langData[lg] || {}; ['icon_search_type', 'icon_projector_type', 'display_mode', 'icon_search', 'icon_projector'].forEach(function (k) { if (L[k] && typeof L[k] === 'object') Object.keys(L[k]).forEach(function (s) { if (/^\d+$/.test(s)) ss[s] = true; }); }); });
      var shops = Object.keys(ss).sort(function (a, b) { return (+a) - (+b); });
      if (!shops.length) shops = Object.keys(shopNames).length ? Object.keys(shopNames).sort(function (a, b) { return (+a) - (+b); }) : ['1'];
      var curShop = shops[0];
      ...
      footer.innerHTML = '<button type="button" class="tm-ai-footer-btn tp-copylang"><span class="material-symbols-outlined">content_copy</span>Powiel nazwę i opis na języki</button><div class="tm-footer-right"><button type="button" class="tm-btn-cancel">Anuluj</button><button type="button" class="tm-btn-save">Zapisz</button></div>';
      modal.appendChild(footer);
      ...
      function renderGfx() {
        ...
        [['search', 'Grafika na liście towarów'], ['projector', 'Grafika na karcie towaru']].forEach(function (pair) {
          ...
          function renderSlots() {
            ...
            // Istniejąca grafika (najlepsze dopasowanie: single → desktop → tablet → mobile)
            var L2 = (dt.langData && dt.langData[curLang]) || {};
            var existingKey = null;
            ['icon_' + cx, 'icon_' + cx + '_desktop', 'icon_' + cx + '_tablet', 'icon_' + cx + '_mobile'].some(function (k) { if (L2[k] && L2[k][curShop]) { existingKey = k; return true; } });
            if (existingKey) {
              var cur = _abs(L2[existingKey][curShop]);
              ...
              function doDelete() {
                if (!confirm('Usunąć grafikę (' + title + ', ' + getLangName(curLang) + ', sklep ' + shopLabel(curShop) + ')?')) return;
                delEl.textContent = 'Usuwanie…';
                var rwd = (typSel.value === 'img_rwd');
                var chain = gfxRemove(cx, curShop, curLang, null);
                if (rwd) { ['desktop', 'tablet', 'mobile'].forEach(function (v) { chain = chain.then(function () { return gfxRemove(cx, curShop, curLang, v); }); }); }
                chain.then(function () {
                  ['icon_' + cx, 'icon_' + cx + '_desktop', 'icon_' + cx + '_tablet', 'icon_' + cx + '_mobile'].forEach(function (k) { if (L2[k]) L2[k][curShop] = ''; });
                  gfxEnableState[ekey] = 'n';
                  if (_panel) _panel.showStatus('Usunięto grafikę');
                  renderGfx();
            ...
            // Tryb „wskaż grafiki" — rzędy uploadu wg typu
            var rows = (typSel.value === 'img_rwd')
              ? [['desktop', 'Nowa grafika (komputer):'], ['tablet', 'Nowa grafika (tablet):'], ['mobile', 'Nowa grafika (smartfon):']]
              : [['single', 'Nowa grafika:']];
            rows.forEach(function (r) { slots.appendChild(mkUploadRow(r[1], cx, curShop, r[0])); });
          }
      ...
      footer.querySelector('.tp-copylang').addEventListener('click', function () {
        stashName();
        var src = curLang;
        if (!confirm('Skopiować nazwę i opis z „' + getLangName(src) + '" do wszystkich pozostałych języków?')) return;
        langs.forEach(function (lg) { if (lg !== src) { st[lg].name = st[src].name; st[lg].description = st[src].description; } });
        if (_panel) _panel.showStatus('Powielono nazwę i opis na ' + (langs.length - 1) + ' języków (zapisz, aby zatwierdzić)');
