...
/* v4.6.117: na hover wiersza wartości (ma .tp-drag-handle — parametry nie mają)
   ukrywamy checkbox w col-check, żeby ⠿ był widoczny na jego miejscu */
li.panel-pro__row:hover:has(.tp-drag-handle) > .tp-col-check {
  opacity: 0;
  transition: opacity 0.12s;
}
