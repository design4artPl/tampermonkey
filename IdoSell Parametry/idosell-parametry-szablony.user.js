...
// @version      4.1.0
// @description  Toolbar do grupowej edycji parametrow: panel-pro v1.1.0 (opsBar, selectionBar), checkboxy, zaznaczanie, rozwijanie/zwijanie, grupowe usuwanie/edycja, import CSV
// @author       SyncOffer
// @match        https://*.iai-shop.com/panel/app/parameters.php*
// @match        https://*.idosell.com/panel/app/parameters.php*
// @require      https://raw.githubusercontent.com/design4artPl/tampermonkey/panel-pro/v1.1.0/_shared/panel-pro/panel-pro.js
// @grant        none
  ...
  function buildPageHeader(doc) {
    ...
    header.innerHTML =
      '<div class="tp-page-header__top">' +
        ...
        '<button class="tp-btn tp-btn--primary" id="tp-add-element-btn">' +
          '<span class="material-symbols-outlined">add</span> Dodaj' +
        '</button>' +
      '</div>' +
      '<div class="tp-page-header__meta">' +
        '<span class="tp-page-header__lang-label">Wybrany j\u0119zyk:</span>' +
        '<span class="tp-page-header__lang">' + getLangFlag(currentLang) + ' <strong>' + getLangName(currentLang) + '</strong></span>' +
        (otherLangs.length > 0 ? '<span class="tp-page-header__lang-separator">|</span>' + langLinksHtml : '') +
      '</div>';
    ...
    // Wire "Dodaj" button to native "Dodaj element" link
    var addBtn = doc.getElementById('tp-add-element-btn');
    if (addBtn) {
...
`;
  ...
  function enhanceRow(li, doc) {
    ...
    const priorityCell = buildPriorityCell(doc, li, nodeId);
    ...
    li.insertBefore(priorityCell, li.firstChild);
  ...
  function mountPanelPro(doc) {
    ...
    if (!mountTarget || !treeRoot) {
      console.error('[parametry] mountTarget or treeRoot not found');
      return null;
    }
    ...
    var panel = PanelPro.mount(doc, {
      ...
      columns: [
        ...
        { id: 'priority', label: 'Priorytet',width: '110px' },
