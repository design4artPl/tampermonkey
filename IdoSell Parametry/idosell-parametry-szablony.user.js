  ...
  function mountSectionsPanel(doc) {
    ...
    var sectionsPanel = PanelPro.mount(doc, {
      ...
      columns: [
        ...
        { id: 'actions',  label: 'Akcje',        width: '150px' }
      ],
      selectionBar: {
    ...
    sections.forEach(function (sec) {
      ...
      li.innerHTML =
        ...
        '<div style="display:flex;align-items:center;justify-content:center;gap:6px">' +
          ...
          '<span class="material-symbols-outlined" data-act="merge" title="Połącz z inną sekcją" style="cursor:pointer;color:#e37400;font-size:20px">cell_merge</span>' +
