...
(function (root) {
  ...
  var CSS = [
    ...
    'li.panel-pro__row { display: grid !important; column-gap: 10px; align-items: center; padding: 4px 0 !important; border: none !important; border-radius: 0 !important; border-bottom: 1px solid #f1f5f9 !important; min-height: 37px; transition: background 0.1s; list-style: none !important; margin: 0 !important; box-sizing: border-box; }',
...
`;
  ...
  waitForIframe(function (doc) {
    ...
    updateCounter(doc);
    // v4.5.18: rebuild views dropdown with saved views
