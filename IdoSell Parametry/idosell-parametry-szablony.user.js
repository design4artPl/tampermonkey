...
`;
  ...
  function showExportModal(targetDoc, defaultScope, kind) {
    ...
    var stateExtras = isSec ? [
      ...
      // v4.6.144: ustawienia per shop+lang (display/headline/listDesc/filtry)
      { key: 'shopSettings', label: 'Ustawienia per sklep', desc: 'Wyświetlanie + nagłówek + opis listy + filtry — per shop × lang (1× getNode per element/shop/lang)', on: false }
    ];
    var savedApiKey = '';
