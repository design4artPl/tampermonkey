          ...
          '<div style="padding:14px 0;border-top:1px solid #f0f2f5">' +
            ...
            '<div style="display:flex;flex-direction:column;gap:8px">' +
              '<div style="display:flex;gap:20px;flex-wrap:wrap">' +
                ...
                '</label>' +
              '</div>' +
              // v4.6.142: pola per-shop (kopiowane na inne jezyki w biezacym sklepie)
              '<div style="display:flex;gap:20px;flex-wrap:wrap;padding-top:6px;border-top:1px dashed #e8ebf0">' +
                '<label class="tpcd-what" data-field="headline" style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:13px;font-weight:500;color:#344054">' +
                  checkboxBtn(copyHeadline, false) + 'Nazwa w nagłówku' +
                '</label>' +
                '<label class="tpcd-what" data-field="listDesc" style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:13px;font-weight:500;color:#344054">' +
                  checkboxBtn(copyListDesc, false) + 'Opis na liście' +
                '</label>' +
              '</div>' +
              '<div style="font-size:11px;color:#98a2b3;font-style:italic;line-height:1.4">Nagłówek i opis listy: kopiowane w bieżącym sklepie</div>' +
            '</div>' +
          '</div>' +
          // Język źródłowy
          '<div style="padding:14px 0;border-top:1px solid #f0f2f5">' +
