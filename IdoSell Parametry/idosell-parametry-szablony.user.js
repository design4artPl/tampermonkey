  ...
  function showValueSeoModal(doc, nodeId) {
    ...
    fetchAjax('action=getParameterLangData&id=' + encodeURIComponent(nodeId)).then(function (resp) {
      ...
      header.innerHTML =
        '<div class="tm-settings-header-left">' +
          ...
          '<div class="tm-settings-header-text">' +
            ...
            '<div class="tm-settings-header-subtitle">ID: ' + esc(nodeId) + ' · wartość parametru</div>' +
          '</div>' +
        '</div>' +
      ...
      function sectionsHtml(dnode) {
          ...
          '<div class="tm-section-card tm-section-card--seo">' +
            ...
            '<div class="tm-section-body">' +
              '<div class="tm-field-row"><span class="tm-field-label">Sklep</span>' +
                makeSelect('tp_shop', shops.map(function (s) { return [s, 'Sklep ' + s]; }), curShop, 'storefront') + '</div>' +
            ...
            '<div class="tm-section-body">' +
              ...
              '<div class="tm-field-row tm-seo-url-row"><span class="tm-field-label">Adres URL</span>' +
                '<div class="tm-seo-url-input-wrap">' +
                  ...
                  '<button type="button" class="tm-seo-url-trash" disabled><span class="material-symbols-outlined">delete</span></button>' +
                '</div>' +
              '</div>' +
        ...
        var redirCard =
          '<div class="tm-section-card tm-section-card--seo">' +
            ...
            '<div class="tm-section-body">' +
              '<div id="tp-seo-redirects"><button type="button" class="tm-redirect-add-btn">' + ICON_PLUS + ' Dodaj przekierowanie</button>' +
              '<div class="tm-redirects-empty">Brak przekierowań</div></div>' +
            '</div>' +
          '</div>';
      ...
      function wire() {
        ...
        var radd = bodyEl.querySelector('.tm-redirect-add-btn');
        if (radd) radd.addEventListener('click', function () {
      ...
      function load() {
        ...
        bodyEl.innerHTML = '<div class="tm-node-loading"><div class="tm-spinner"></div>Wczytywanie danych...</div>';
