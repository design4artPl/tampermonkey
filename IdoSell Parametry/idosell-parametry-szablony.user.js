...
.tp-drag-handle {
  /* v4.6.114: hover-only — uchwyt pojawia się po najechaniu na wiersz wartości,
     pozycjonowany absolute względem li.panel-pro__row, w obszarze checkbox/kolumna check */
