...
.tp-drag-handle {
  /* v4.6.114/115: hover-only — uchwyt pojawia się po najechaniu na wiersz wartości,
     pozycjonowany absolute względem li.panel-pro__row, w kolumnie expand
     (gdzie wartości mają ↳, na prawo od checkboxa — nie nakłada się) */
