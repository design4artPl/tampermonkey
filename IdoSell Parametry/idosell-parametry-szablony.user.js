        ...
        '<div style="padding:0 22px 20px">' +
          ...
          '<div style="padding:14px 0;border-top:1px solid #f0f2f5">' +
            ...
            '<div style="position:relative">' +
              '<select class="tpcd-src" style="width:100%;padding:10px 36px 10px 14px;border-radius:8px;border:1px solid #e0e3ea;background:#f8f9fb;font-size:13.5px;color:#1a1a2e;appearance:none;outline:none;cursor:pointer;font-family:' + FONT + '">' + srcOpts + '</select>' +
