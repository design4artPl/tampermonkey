...
`;
  ...
  function showExportModal(targetDoc, defaultScope, kind) {
    ...
    var CSS = [
      ...
      // v4.6.149: lista sklepow — max 2 kolumny (domeny moga byc dlugie); 1 kolumna gdy waska
      '.lang-list[data-role="shop-list"] { grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); }',
      '.shop-item .lang-name { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; min-width: 0; }',
    ...
    // v4.6.148: lista sklepow — bez ikon, max 2 kolumny (domeny moga byc dlugie)
