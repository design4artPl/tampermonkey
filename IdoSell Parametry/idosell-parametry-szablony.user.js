      ...
      li.querySelectorAll('[data-act]').forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          ...
          if (act === 'products') {
            ...
            fetchAjax('action=removeParam&id=' + encodeURIComponent(sec.id))
              .then(function (resp) {
                if (resp && resp.errno && resp.errno !== 0) { alert('B\u0142\u0105d: ' + (resp.message || resp.errno) + ' (sekcja mo\u017ce by\u0107 u\u017cywana w produktach)'); return; }
