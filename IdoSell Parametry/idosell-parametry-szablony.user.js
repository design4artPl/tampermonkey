...
/* Drag handle — slot zachowuje szerokość 24px nawet gdy pusty (param bez drag),
   żeby checkbox/folder były w spójnej kolumnie z drag iconami wartości. */
.tp-col-drag {
  display: flex !important;
  align-items: center !important;
  justify-content: center !important;
...
/* v4.6.81: STAŁE SLOTY ikon akcji — settings i delete zawsze w tej samej kolumnie
   niezależnie od typu wiersza (parametr ma 6 ikon, wartość 4). Klasy .tp-act-* na
   ikonach przydzielają grid-column. Aktion-cell jest sterowany flex/center. */
.tp-col-actions {
  display: grid !important;
...
.tp-col-actions .tp-act-add        { grid-column: 1; }
.tp-col-actions .tp-act-settings   { grid-column: 2; }
.tp-col-actions .tp-act-star,
.tp-col-actions .tp-act-seo        { grid-column: 3; }
.tp-col-actions .tp-act-sort-alpha { grid-column: 4; }
.tp-col-actions .tp-act-sort-id,
.tp-col-actions .tp-act-merge      { grid-column: 5; }
.tp-col-actions .tp-act-delete     { grid-column: 6; }
