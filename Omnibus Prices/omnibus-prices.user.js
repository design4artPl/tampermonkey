...
(function () {
  ...
  // API returns short forms ("automatic", "manual") while long forms appear in docs / PUT ("automatic_calculation", "manual_entering").
  // Treat them as equivalent so verification doesn't false-positive on mode mismatch.
  const MODE_ALIASES = {
    'automatic': 'automatic_calculation',
    'automatic_calculation': 'automatic_calculation',
    'manual': 'manual_entering',
