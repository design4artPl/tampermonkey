...
// @version      1.6
// @description  Export klientow z panelu zrodlowego (API lub CSV) i porownanie z panelem docelowym — match po login+email, generuje brakujacy_klienci.csv i adresy_do_dodania.csv
    ...
    overlay.innerHTML = `
      <div id="idosell-cust-modal">
        ...
        <div class="section hide" id="cust-tgt-section">
          ...
          <label>shopId (puste = bez filtra)</label>
          <input id="cust-tgt-shop" type="text" placeholder="puste = wszyscy klienci panelu" value="${ts}">
        </div>
