...
// @version      1.3
// @description  Eksport opisow + YouTube + slow wyszukiwarki (iframe + CKEditor/TinyMCE)
// @author       Claude
...
(function() {
                ...
                setTimeout(function() {
                    ...
                    try {
                        ...
                        var data = {
                            ...
                            slowa_wyszukiwarki: getTextareaPlain(doc, 'description_pane[language_data][1][search_words]'),
                            youtube_id: getInput(doc, 'description_pane[language_data][1][yt1]'),
                            youtube_id_2: getInput(doc, 'description_pane[language_data][1][yt2]')
                        };
                        resolved = true;
    ...
    // Plain textarea (bez WYSIWYG) - dla slow wyszukiwarki itp.
    function getTextareaPlain(doc, name) {
    ...
    function isValidProduct(data) {
        ...
        return !!(data.nazwa || data.opis_krotki || data.opis_dlugi || data.opis_dodatkowy || data.youtube_id || data.youtube_id_2 || data.slowa_wyszukiwarki);
    }
    ...
    function createUI() {
        ...
        ui.innerHTML = ''
            ...
            + '<h3>📝 Description Exporter v1.3 (HTML+YT)</h3>'
    ...
    function exportToCSV(products, suffix) {
        suffix = suffix || '';
        var headers = ['ID', 'Nazwa', 'Opis krotki (HTML)', 'Opis dlugi (HTML)', 'Opis dodatkowe info (HTML)', 'Slowa wyszukiwarki', 'YouTube ID', 'YouTube ID 2', 'Status'];
